...
//     {/*start Home part3 */}
// <div className='Home-part3 mb-5 mt-3'>
//   <div className='container'>
...
//   <div className="container">
//     <h2 className="text-center text-primary fw-bold mt-5 mb-5">
//       <i className="fa-solid fa-arrows-rotate text-black"></i>Be A part of Revive Memory 2023<i className="fa-solid fa-arrows-rotate text-black"></i>
//     </h2>
//     <div className="row d-flex justify-content-between">
//       <div className="col-md-3 gy-5">
//         <div className="card animate__animated animate__fadeInUp">
//           <div className="card-body p-2">
//             <h5 className="card-title text-center text-primary fw-bold">Part of Doctor</h5>
//            <p className="card-text text-muted">
//               Alzheimer’s disease (AD) is an irreversible brain disease. It slowly destroys a person’s mind and their ability to complete everyday tasks. There is currently no cure for AD. Doctors diagnose AD by performing physical examinations, conducting tests, noting behavior changes, and assessing memory impairment. There are many types of doctors who can diagnose and treat AD. If you’re worried a loved one might have AD, read on to see which doctors might be involved in treating the disease and how to find the right specialists.
//             </p>
//             {/* <button className="btn btn-primary btn-patient p-2 mt-2 animate__animated animate__fadeInUp animate__delay-1s">Connect to Doctor</button> */}
//             <button className="btn btn-primary btn-patient p-2 mt-2  m-auto animate__animated animate__fadeInUp animate__delay-1s" data-tooltip="Click here to connect with a doctor">Connect to Doctor</button>
//           </div>
//         </div>
//       </div>
//       <div className="col-md-3 gy-5">
...
//           <div className="card-body p-2">
//             <h5 className="card-title text-center text-primary fw-bold">Part of Patient</h5>
//             <p className="card-text text-muted">
//               During the later stages of Alzheimer’s disease, a person may lose the ability to move and spend much of his or her time in a bed or chair. This lack of movement can cause problems such as pressure sores or bedsores, and stiffness of the arms, hands, and legs. If the person withAlzheimer’s cannot move around on his or her own, contact a home health aide, physical therapist, or nurse for help. These professionals can show you how to move the person safely. 
//             </p>
//             <a href="#">
//               <button className="btn btn-primary btn-patient p-2 mt-2 m-auto animate__animated animate__fadeInUp animate__delay-1s">Connect to Patient</button>
//             </a>
//           </div>
//         </div>
//       </div>
...
//           <div className="card-body">
//             <h5 className="card-title text-center text-primary fw-bold">Part of Volunteer</h5>
//             <p className="card-text text-muted">
//             Alzheimer's Association volunteers deliver support and education, raise funds, advocate for Alzheimer’s and more to help achieve our vision of a world without Alzheimer’s and all other dementia®. Whatever your skills and whatever time you have available, we have in-person and virtual opportunities to provide vital support for people living with Alzheimer's and their families. At the Alzheimer's Association, we believe in the
//             </p>
//             <button className="btn btn-primary btn-patient mt-4 p-1  m-auto w-50 mt-3 animate__animated animate__fadeInUp animate__delay-4s">Connect to Volunteer</button>
//           </div>
//         </div>
//       </div>
//       <div className="col-md-3 gy-5">
//         <div className="card animate__animated animate__fadeInUp animate__delay-5s">
//           <div className="card-body">
//             <h5 className="card-title text-center text-primary fw-bold">Part of Contributors</h5>
//             <p className="card-text text-muted">
//               This study aimed to identify the variables that contribute to Quality of Life (QoL) of Alzheimer’s Disease (AD) caregivers, taking into consideration the caregiving context, stressors, role strains, and resources. The sample included 102 caregivers of AD patients who answered the following instruments: Depression, Anxiety and Stress Scale-21; Satisfaction with Social Support Scale;
//             </p>
//             <button className="btn btn-primary btn-patient py-3 mt-4 m-auto animate__animated animate__fadeInUp animate__delay-6s">Connect To Contributors</button>
//           </div>
//         </div>
//       </div>
//     </div>
...
<h1 className=''>
  Revive My Memory<span aria-busy="true" aria-label="Loading" role="progressbar" class="container">
 <div class="swing">   <div class="swing-l"></div>
     <div></div>
    <div></div>
    <div></div>
    <div></div>
    <div></div>    <div class="swing-r"></div>
 </div>
 </span>
</h1>
 <p className='mb-5 text-muted p-1'>
 Memory Recovery is the goal we work to protect patients<br></br>
  ...
  However, certain activities can engage the brain in new ways<br></br>
    potentially leading to improvements in memory, cognitive function, or creativity.
       ...
       <div className='col-md-6 right-content'>
        ...
        <div className='gallary'>
          ...
          <p><img src={newmod}></img> <span className='ms-5 mt-2'><img src={newprec}></img>
      </span>
         </p>
      </div>       </div>
   </div>
   ...
   {/*start Home part2 */}
   <div className='Home-part2 mt-5 mb-5 p-5'>
    <div className='container'>
    <div className='row d-flex justify-content-between'>
    <div className='left-part2 col-md-6 newlog'>
      <img src={newlog} alt="" className='mt-5 w-75'/>
    ...
    <div className='right-part2 col-md-6 '>
      <h2 className='text-primary mb-2 ms-3'>Revive My Memory</h2>
      <p className='mb-2 mt-3 p-part2 text-muted ms-3'>
      Mild cognitive impairment (MCI) is the stage between<br></br> the expected decline in memory and thinking that happens<br></br> with age and the more serious decline of dementia.<br></br> MCI may include problems with memory, language<br></br>People with MCI may be aware that their memory<br></br> or mental function has "slipped."       </p>
      <button className='btn btn-primary me-3 mt-3 ms-3'>Register</button>
      <a href='https://www.mayoclinic.org/diseases-conditions/alzheimers-disease/symptoms-causes/syc-20350447'>
      <button className='btn btn-primary me-3 mt-3'>Learn More</button>
...
<h2 className='text-center mb-5 fw-bold text-primary'>Our Team</h2>
      ...
      <div>
       <img className="team-member-image w-25 animate__animated animate__fadeIn" src={Picture2t} />
      <img className="team-member-image w-25 animate__animated animate__fadeIn" src={Picture4t} />       <img className="team-member-image w-25 animate__animated animate__fadeIn" src={Picture3t} />
       </div>
      </div>
...
{/* <img src={Hom3new} className='w-100'></img> */}
 ...
 <img src={pic9} className="w-25"id='flutter'></img>
 <img src={pic8} className="w-25"id='flutter'></img>
 <img src={pic11} className="reactp ms-5 mb-5 mt-5 "id='flutter'></img>   </div>
   <div className='part2 col-md-4'>
   <img src={pic1} className="w-75"id='Github'></img>
   </div>
 ...
 <div className="card p-3" >
  ...
  the bracelet uses biometric sensors that measure the wearer’s heart rate, heart rate variability
   ...
   <a href="#" className="btn btn-primary ms-3">Breclete Details</a>
    ...
    <div className="last-part mb-5">
   <div className="container">
     <h2 className="text-center text-primary fw-bold mt-5 mb-5">       <i className="fa-solid fa-arrows-rotate text-black"></i>Be A part of Revive Memory 2023<i className="fa-solid fa-arrows-rotate text-black"></i>
    </h2>
    <div className="row d-flex justify-content-between">
      <div className="col-md-3 gy-5">
        <div className="card animate__animated animate__fadeInUp">
