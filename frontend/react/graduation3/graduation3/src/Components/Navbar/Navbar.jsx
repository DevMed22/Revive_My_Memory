  ...
  <div className="container-fluid">
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav ms-auto  mb-lg-0 ">
        ...
        <li className="nav-item">
          <Link className="nav-link text-primary" to='MemoAi'>MemoAI</Link>
        </li>
        <li className="nav-item">
          <Link className="nav-link text-primary" to='HowWorks'>Posts</Link>
        </li>
        <li className="nav-item">
          <Link className="nav-link text-primary"to='ChatMemory' >ChatMemory</Link>
        </li>
        <li className="nav-item">
          <Link className="nav-link text-primary" to='Solution'>Solution</Link>
        </li>
        ...
        <li className="nav-item">
          <Link className="nav-link text-primary" to='PatientRegister'>PatientRegister</Link>
        </li>

        {/* <li className="nav-item">
          <Link className="nav-link text-primary" to='DoctorRegister'>DoctorRegister</Link>
        </li>  */}
        {/* <li className="nav-item">
          <Link className="nav-link text-primary" to='Volunterregister'>VolunterRegister </Link>
        </li> 
        <li className="nav-item">
          <Link className="nav-link text-primary" to='PatientRegister'>PatientRegister</Link>
        </li>  */}
